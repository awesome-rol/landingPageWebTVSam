...
const comoFuncionaList = [
    {id: 1, text: "1) Após a contratação você receberá um email com todas as informações e orientações (video aulas, tutoriais, etc). E poderá contar com o nosso suporte ao vivo pelo Whatsapp."},
